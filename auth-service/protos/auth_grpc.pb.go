...
const (
	AuthService_GoogleSignIn_FullMethodName = "/auth.AuthService/GoogleSignIn"
)
...
func (c *authServiceClient) GoogleSignIn(ctx context.Context, in *GoogleSignInRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
...
func (UnimplementedAuthServiceServer) GoogleSignIn(context.Context, *GoogleSignInRequest) (*AuthResponse, error) {
